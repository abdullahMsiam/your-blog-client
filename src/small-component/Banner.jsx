    ...
    return (
        <div className=' h-[500px] flex flex-col items-center md:gap-6 justify-center bg-gradient-to-r from-blue-100 to-purple-100 rounded-b-3xl md:rounded-b-3xl shadow-xl'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-center w-4/5 text-xl mt-5 text-gray-600'>Share your thoughts, read inspiring stories, and connect with voices that matter.</p>
            </div>
            <div className='w-80 p-1  text-center mt-6 border-2 border-gray-400 rounded-full mx-auto '>
                <form action="" className='flex items-center justify-between'>
                    ...
                    <input className='btn btn-info rounded-full' type="submit" value="Search" />
                </form>
            </div>
        </div>
    )
