...
const Subscribtion = () => {
    return (
        <div className='max-w-5xl mx-auto mt-10 '>
            <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-10 rounded-3xl shadow-lg h-[350px] flex flex-col items-center justify-center w-11/12 mx-auto md:w-full">
                ...
                <form className="flex justify-center p-1 border border-gray-600 rounded-md md:w-1/2">
                    <input
                        type="email"
