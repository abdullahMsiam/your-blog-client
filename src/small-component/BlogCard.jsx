...
const BlogCard = ({ blog }) => {
    ...
    return (
        <div>
            <div className="cursor-pointer card bg-blue-50 md:w-[330px] h-[340px] shadow-sm" onClick={() => navigate(`/blog/${_id}`)}>
                <figure>
                ...
                <div className="p-2">
                    <button className='btn btn-secondary btn-outline btn-xs '>{category}</button>
